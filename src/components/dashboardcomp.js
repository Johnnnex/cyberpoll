      ...
      <div className="container">
        <header>
          <div className="user">
            ...
            <small id="username">Welcome, {user}</small>
          </div>
          <div className="dropDown">
            ...
            {/* <label htmlFor="dropDown">
              Connect Your Wallet<i className="fa-solid fa-angle-down"></i>
            </label>
            {/* <ul id="dropDown">
            ...
            {/* <ul id="nav-alternative">
              ...
              <li>
                Wallet connect{" "}
                <img src="assets/images/WalletConnect-Logo.jpg" alt="" />
              </li>
              <li>
                Coinbase&nbsp;
